...
> **CALMOS Connect white-label v1.46.0.4.2** ([applied-biosciences/dograh](https://github.com/applied-biosciences/dograh)): this fork adds the Sakinah Scenario Console, AI-to-AI simulation, durable call storage, privacy-controlled memory, and scenario search — see [`SAKINAH.md`](SAKINAH.md) and [`docs/developer/calmos-connect-v1.46.0.3.mdx`](docs/developer/calmos-connect-v1.46.0.3.mdx).
...
CALMOS Connect v1.46.0.4.2 includes the Sakinah Scenario Console at `/sakinah` and
...
For the CALMOS Connect v1.46.0.4.2 data model, AWS storage configuration, memory
