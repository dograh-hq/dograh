...
# Sourced from https://ai.google.dev/gemini-api/docs/live-api/live-translate on 2026-06-13.
# Update manually if Google publishes new languages.
GOOGLE_REALTIME_TRANSLATE_MODELS = ("gemini-3.5-live-translate-preview",)
