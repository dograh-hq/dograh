...
def create_tts_service(
    ...
    if user_config.tts.provider == ServiceProviders.DEEPGRAM.value:
        ...
        # Both Speaches (self-hosted OpenAI-compatible) and Gandr (flat-rate
        # TTS, also OpenAI-compatible at /v1/audio/speech) reuse the thin
        # Speaches service, which passes voice/model through unchanged and
        # streams raw PCM. base_url is the provider's /v1 root.
        _validate_runtime_service_url(user_config.tts.base_url, "base_url")
