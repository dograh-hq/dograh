...
class VobizProvider(TelephonyProvider):
    ...
    async def verify_webhook_signature(
        self, url: str, params: Dict[str, Any], signature: str, timestamp: str = None, body: str = ""
    ) -> bool:
        """
        ...
        if not self.auth_token:
            logger.error("No auth_token available for Vobiz webhook signature verification")
            return False
        ...
        try:
            ...
            if not is_valid:
                logger.warning(f"Vobiz webhook signature mismatch. Expected: {expected_signature[:8]}..., Got: {signature[:8]}...")
...
<Response>
    ...
    def parse_inbound_webhook(webhook_data: Dict[str, Any]) -> NormalizedInboundData:
        ...
        return NormalizedInboundData(
            ...
            from_number=VobizProvider.normalize_phone_number(webhook_data.get("From", "")),
    ...
    async def verify_inbound_signature(
        self, url: str, webhook_data: Dict[str, Any], signature: str, timestamp: str = None, body: str = ""
    ) -> bool:
        """
        ...
        """
        return await self.verify_webhook_signature(url, webhook_data, signature, timestamp, body)
