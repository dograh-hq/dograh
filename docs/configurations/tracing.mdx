...
## Setting Up Tracing in (Open Source) Self hosted Zoren Voice AI

### Langfuse Integration

We provide seamless integration with Langfuse for self-hosted Zoren Voice deployments.
...
Once enabled, traces will be available for every completed call in Zoren Voice.
