...
Zoren Voice platform ships with Elevenlabs, Deepgram, OpenAI and Zoren Voice TTS engines by default. There are some voices from the providers that we ship by default. You can refer to the providers API documentation to select a voice ID thats most relevant for your language requirement.
