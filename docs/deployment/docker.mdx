---
title: "Docker"
description: "Deploy Zoren Voice AI using Docker for local development and remote server environments"
---

Zoren Voice AI can be deployed using Docker in two main configurations. Choose the option that best fits your needs:
...
Watch the video tutorial below for a step-by-step walkthrough of setting up Zoren Voice AI locally with Docker.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.tella.tv/video/dograh-local-setup-with-docker-5wsf/embed?b=1&title=1&a=1&loop=0&t=0&muted=0&wt=1"
  title="Zoren Voice Local Setup with Docker"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>

For local development and testing, you can run Zoren Voice AI directly on your machine using Docker with a single command.

### Quick Start

Run this single command to download and start Zoren Voice AI:
...
After the setup script completes, start Zoren Voice:
