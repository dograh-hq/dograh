---
title: "Deployments"
description: "Options for deploying Dograh — from a local setup to a production remote server with a custom domain."
---

Dograh is delivered via Docker images (`dograh-api` and `dograh-ui`) plus Postgres, Redis, and MinIO, orchestrated with Docker Compose. Pick the deployment path that matches what you're trying to do:
