...
<Note>
Using the hosted platform, go to [app.dograh.com](https://app.dograh.com). For a private deployment, use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>
