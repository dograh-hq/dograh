...
**Zoren Voice is an open-source alternative to Vapi** - Zoren Voice helps you build voice AI agents with an easy drag-and-drop workflow builder. Unlike proprietary solutions like Vapi, Zoren Voice gives you:
...
## Overview
Watch the following video to learn about Zoren Voice’s capabilities.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/sxiSp4JXqws"
  title="Zoren Voice Overview"
