---
title: "Prerequisites"
description: "System requirements and setup needed to run Zoren Voice AI locally"
---
...
To run Zoren Voice AI locally, make sure you have the following installed:
...
Zoren Voice images are available from two registries:
