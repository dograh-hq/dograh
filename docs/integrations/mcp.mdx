...
Dograh exposes an [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) server that lets AI assistants like Codex, Claude Code, Claude Desktop, and Cursor access your workspace and documentation. Once connected, an assistant can list your agents, fetch agent definitions, estimate what a call will cost before placing it, and search Dograh docs on your behalf.
...
- "What would a 3-minute call on my *Lead Qualifier* agent cost?"
