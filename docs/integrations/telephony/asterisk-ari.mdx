...
<Tabs>
  ...
  <Tab title="Private deployment">
    ...
    <Note>
    Private deployments on an internal network may use an unencrypted WebSocket (`ws://`). If your Dograh instance is exposed over HTTPS, use `wss://` and the corresponding hostname instead.
    </Note>
  </Tab>
</Tabs>
