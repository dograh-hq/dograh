...
description: "Configure Cloudonix for voice communication in Zoren Voice AI"
---

## Overview

Cloudonix is a cloud communications platform that enables Zoren Voice voice agents to connect to SIP communications
...
Watch this step-by-step guide to set up Cloudonix with Zoren Voice AI:

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/qLKX0F99jpU?si=tA3zwCsNRKe-WCI1"
  title="Zoren Voice Cloudonix Setup"
...
The Zoren Voice AI configuration for inbound calling is **identical** to outbound calling - use the same credentials configured above. However, you need additional setup in your Cloudonix Console to route incoming calls to Zoren Voice AI.
...
3. Check call logs in both Zoren Voice AI dashboard and Cloudonix Console
...
<AccordionGroup>
  ...
  <Accordion title="Inbound calls not reaching voice agent">
    ...
    - Check routing rules point to correct Zoren Voice AI webhook endpoint
