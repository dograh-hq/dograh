...
description: "Build your own telephony provider integration for Zoren Voice AI"
---

## Overview

Zoren Voice AI's telephony abstraction layer allows you to integrate any telephony service by implementing the `TelephonyProvider` interface.
