...
description: "Configure Twilio for voice communication in Zoren Voice AI"
---

## Overview

Twilio is a cloud communications platform that enables voice calling, messaging, and video capabilities. Zoren Voice AI's Twilio integration provides seamless connectivity for your voice agents.
...
1. **Configure Phone Number Webhook**:
   ...
   - In the "Voice Configuration" section:
     - Set **Webhook** to: `https://api.zoren-voice.ashtra.ai/api/v1/telephony/inbound/{workflow_id}`
...
3. Check call logs in both Zoren Voice AI dashboard and Twilio Console
