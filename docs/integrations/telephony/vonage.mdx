...
description: "Configure Vonage (Nexmo) for voice communication in Zoren Voice AI"
---

## Overview

Vonage (formerly Nexmo) is a cloud communications platform that provides global voice, messaging, and video capabilities. Zoren Voice AI's Vonage integration enables high-quality voice interactions with your agents using Vonage's robust infrastructure.
...
Watch this step-by-step guide to set up Vonage with Zoren Voice AI:
...
<iframe
  ...
  title="Zoren Voice Vonage Setup"
...
### Step 3: Configure in Zoren Voice AI
