...
description: "How Zoren Voice AI handles telephony webhooks and audio streaming"
---

## Overview

Zoren Voice AI uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
