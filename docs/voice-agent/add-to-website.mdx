...
The snippet you copy from the dashboard carries a `data-dograh-context` attribute — a JSON object of details about the visitor. It ships with two examples you can edit or replace:
...
Because it's built in JavaScript at page load, you can put anything your page knows in it — a logged-in customer's name, their plan, cart contents:
