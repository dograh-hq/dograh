...
description: "Zoren Voice provides UI components to build a voice Agent. The voice agent can be created by going to https://zoren-voice.ashtra.ai/workflow and then Creating a new Agent."
---
