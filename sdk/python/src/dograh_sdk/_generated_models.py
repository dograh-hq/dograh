...
#   filename:  dograh-openapi-XXXXXX.json.2ZOlSiI0p5
#   timestamp: 2026-09-01T03:22:48+00:00
...
class CallDispositionPrompt(RootModel[str]):
    root: Annotated[str, Field(max_length=4000, title='Call Disposition Prompt')]
    """
...
class WorkflowConfigurationDefaults(BaseModel):
    ...
    call_disposition_prompt: Annotated[
        CallDispositionPrompt | None, Field(title='Call Disposition Prompt')
    ] = None
    """
    Optional workflow-wide instructions for deriving a call's business outcome after it ends. When unset, Dograh does not run a dedicated call-disposition extraction.
    """
