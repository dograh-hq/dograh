...
#   filename:  dograh-openapi-HarGzi.json
#   timestamp: 2026-08-10T16:54:44+00:00
...
class FallbackDestination(RootModel[str]):
    ...
    """
    Optional provider-native destination used when no rule matched.
    """
...
class ContextDestinationMappingConfig(BaseModel):
    ...
    rules: Annotated[
        list[ContextDestinationRule], Field(max_length=20, min_length=1, title='Rules')
    ]
    """
