...
#   filename:  dograh-openapi-XXXXXX.json.ynYhbluQTl
#   timestamp: 2026-09-24T00:34:49+00:00
...
class DocumentResponseSchema(BaseModel):
    ...
    has_live_content: Annotated[bool | None, Field(title='Has Live Content')] = False
    """
...
class TransferAgentConfig(BaseModel):
    ...
    """
    play_greeting: Annotated[bool | None, Field(title='Play Greeting')] = True
    """
...
class HttpApiConfig(BaseModel):
    ...
    """
    body_format: Annotated[BodyFormat | None, Field(title='Body Format')] = 'json'
    """
    Encoding of the POST, PUT, and PATCH request body: 'json' sends application/json, 'form' sends application/x-www-form-urlencoded.
    """
