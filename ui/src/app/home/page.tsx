...
import { ArrowRight, ArrowUp, CalendarClock, Headphones, Home as HomeIcon, Loader2, Sparkles, Target } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-background">
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <Link
                    href="/agent-builder"
                    className="group mb-12 block rounded-2xl border border-border/60 bg-card shadow-[var(--shadow-card)] transition-all duration-200 hover:-translate-y-0.5 hover:border-border hover:shadow-[var(--shadow-pop)] focus-visible:ring-1 focus-visible:ring-ring outline-none"
                >
                    <div className="flex items-center gap-4 p-5">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="text-small text-muted-foreground">
                                Describe your business and answer a few quick questions — we&apos;ll generate a working workflow.
                            </p>
                        </div>
