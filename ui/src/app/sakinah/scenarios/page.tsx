...
import { Copy, Library, Pencil, Play, Plus, Trash2 } from "lucide-react";
...
import {
    ...
    loadScenarios, saveScenarios, type Scenario, type ScenarioDraft, type ScenarioMode,
    scenarioToDraft,
...
export default function ScenarioLibraryPage() {
    ...
    return <main className="mx-auto w-full max-w-6xl space-y-6 p-4 md:p-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div className="space-y-2"><p className="text-sm font-medium uppercase tracking-[0.2em] text-primary">Sakinah</p><h1 className="text-3xl font-bold tracking-tight">Scenario Library</h1><p className="text-muted-foreground">Create and manage simulated service-user scenarios for Sakinah testing.</p></div><Button onClick={openCreate}><Plus />Create Scenario</Button></header>
