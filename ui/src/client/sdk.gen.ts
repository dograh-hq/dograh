 ...
 */
export const getUploadUrlsApiV1WorkflowRecordingsUploadUrlPost = <ThrowOnError extends boolean = false>(options: Options<GetUploadUrlsApiV1WorkflowRecordingsUploadUrlPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetUploadUrlsApiV1WorkflowRecordingsUploadUrlPostResponse, GetUploadUrlsApiV1WorkflowRecordingsUploadUrlPostError, ThrowOnError>({
 ...
 */
export const createRecordingsApiV1WorkflowRecordingsPost = <ThrowOnError extends boolean = false>(options: Options<CreateRecordingsApiV1WorkflowRecordingsPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateRecordingsApiV1WorkflowRecordingsPostResponse, CreateRecordingsApiV1WorkflowRecordingsPostError, ThrowOnError>({
        url: '/api/v1/workflow-recordings/',
        ...options,
        headers: {
            'Content-Type': 'application/json',
