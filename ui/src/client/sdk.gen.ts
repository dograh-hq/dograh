...
/**
 * Handle Transfer Call Answered
 * Handle when target answers the transfer call
 */
export const handleTransferCallAnsweredApiV1TelephonyTransferCallHandlerToolCallIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleTransferCallAnsweredApiV1TelephonyTransferCallHandlerToolCallIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, HandleTransferCallAnsweredApiV1TelephonyTransferCallHandlerToolCallIdPostError, ThrowOnError>({
 ...
 */
export const completeTransferFunctionCallApiV1TelephonyTransferResultToolCallIdPost = <ThrowOnError extends boolean = false>(options: Options<CompleteTransferFunctionCallApiV1TelephonyTransferResultToolCallIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, CompleteTransferFunctionCallApiV1TelephonyTransferResultToolCallIdPostError, ThrowOnError>({
 ...
 */
export const registerTransferToolCallApiV1TelephonyRegisterTransferToolCallPost = <ThrowOnError extends boolean = false>(options?: Options<RegisterTransferToolCallApiV1TelephonyRegisterTransferToolCallPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
