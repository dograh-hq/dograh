 ...
 */
export const sendTransferSignalEndpointApiV1TelephonyTransferSignalWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<SendTransferSignalEndpointApiV1TelephonyTransferSignalWorkflowRunIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, SendTransferSignalEndpointApiV1TelephonyTransferSignalWorkflowRunIdPostError, ThrowOnError>({
