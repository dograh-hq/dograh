 ...
 */
export const handleCloudonixAmdCallbackApiV1TelephonyCloudonixAmdCallbackWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleCloudonixAmdCallbackApiV1TelephonyCloudonixAmdCallbackWorkflowRunIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, HandleCloudonixAmdCallbackApiV1TelephonyCloudonixAmdCallbackWorkflowRunIdPostError, ThrowOnError>({
