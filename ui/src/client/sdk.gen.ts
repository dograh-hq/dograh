 ...
 */
export const getModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesGet = <ThrowOnError extends boolean = false>(options?: Options<GetModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesGetData, ThrowOnError>) => (options?.client ?? client).get<GetModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesGetResponses, GetModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesGetErrors, ThrowOnError>({ url: '/api/v1/organizations/model-configurations/preferences', ...options });

/**
 * Save Model Configuration Preferences
 */
export const saveModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesPut = <ThrowOnError extends boolean = false>(options: Options<SaveModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesPutData, ThrowOnError>) => (options.client ?? client).put<SaveModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesPutResponses, SaveModelConfigurationPreferencesApiV1OrganizationsModelConfigurationsPreferencesPutErrors, ThrowOnError>({
