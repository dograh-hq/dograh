 ...
 */
export const importToolsApiV1ToolsImportPost = <ThrowOnError extends boolean = false>(options: Options<ImportToolsApiV1ToolsImportPostData, ThrowOnError>): RequestResult<ImportToolsApiV1ToolsImportPostResponses, ImportToolsApiV1ToolsImportPostErrors, ThrowOnError> => (options.client ?? client).post<ImportToolsApiV1ToolsImportPostResponses, ImportToolsApiV1ToolsImportPostErrors, ThrowOnError>({
