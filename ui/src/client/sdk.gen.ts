 ...
 */
export const listToolsApiV1MarketplaceToolsGet = <ThrowOnError extends boolean = false>(options?: Options<ListToolsApiV1MarketplaceToolsGetData, ThrowOnError>) => (options?.client ?? client).get<ListToolsApiV1MarketplaceToolsGetResponses, ListToolsApiV1MarketplaceToolsGetErrors, ThrowOnError>({ url: '/api/v1/marketplace/tools', ...options });
 ...
 */
export const getToolApiV1MarketplaceToolsToolIdGet = <ThrowOnError extends boolean = false>(options: Options<GetToolApiV1MarketplaceToolsToolIdGetData, ThrowOnError>) => (options.client ?? client).get<GetToolApiV1MarketplaceToolsToolIdGetResponses, GetToolApiV1MarketplaceToolsToolIdGetErrors, ThrowOnError>({ url: '/api/v1/marketplace/tools/{tool_id}', ...options });
 ...
 */
export const connectToolApiV1MarketplaceToolsToolIdConnectPost = <ThrowOnError extends boolean = false>(options: Options<ConnectToolApiV1MarketplaceToolsToolIdConnectPostData, ThrowOnError>) => (options.client ?? client).post<ConnectToolApiV1MarketplaceToolsToolIdConnectPostResponses, ConnectToolApiV1MarketplaceToolsToolIdConnectPostErrors, ThrowOnError>({
 ...
 */
export const oauthCallbackApiV1MarketplaceToolsToolIdOauthCallbackPost = <ThrowOnError extends boolean = false>(options: Options<OauthCallbackApiV1MarketplaceToolsToolIdOauthCallbackPostData, ThrowOnError>) => (options.client ?? client).post<OauthCallbackApiV1MarketplaceToolsToolIdOauthCallbackPostResponses, OauthCallbackApiV1MarketplaceToolsToolIdOauthCallbackPostErrors, ThrowOnError>({
