...
export function BrandLogo({
  ...
  if (mark) {
    return (
      ...
      <img src="/dograh-mark.png" alt="BSI" className={cn("w-auto select-none", className)} />
    );
  }
  if (inverse) {
    return (
      // eslint-disable-next-line @next/next/no-img-element
      <img src="/dograh-logo-inverse.png" alt="BSI" className={cn("w-auto select-none", className)} />
    );
  }
  return (
    <>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/dograh-logo.png" alt="BSI" className={cn("block w-auto select-none dark:hidden", className)} />
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/dograh-logo-inverse.png" alt="BSI" className={cn("hidden w-auto select-none dark:block", className)} />
    </>
  );
}
